...
const BoardNew = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    formDataToSend.append(
      "post",
      new Blob([JSON.stringify(postData)], { type: "application/json" }) // JSON을 Blob 형태로 변환
    );
    ...
    try {
      ...
      if (response.status === 200) {
        ...
        navigate(`/board/${type}`); // ✅ 게시글 타입에 따라 이동
      }
    } catch (error) {
      ...
      <form onSubmit={handleSubmit} className="new-editor">
        <div className="new-input">
          ...
          >
            ...
            <option value="site-improve">사이트불편&개선사항</option>
